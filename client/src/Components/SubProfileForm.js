...
render(){
    return (
        ...
        <form>
            ...
            <SelectInput title="Company State" name="companyState" options={this.state.statesUS} selectedOption={this.state.companyState} controlFunc={this.handleInputChange} placeholder="State"/>
            ...
            <SelectInput title="Company Trade Category" name="tradeCategory" options={this.state.tradeCategories} selectedOption={this.state.tradeCategory} controlFunc={this.handleInputChange} placeholder="Select a Category"/>
